...
# ggsave(pfig2, filename = "evaluation.ori.pdf", width = 12, height = 14)
# ggsave(pfig2, filename = "evaluation.ori.eps", width = 12, height = 14)
###### plot dot
...
#
# plot.list.w.ori <- p2
# save(plot.list.w.ori, file = "ggplot.ori.weight.RData")
